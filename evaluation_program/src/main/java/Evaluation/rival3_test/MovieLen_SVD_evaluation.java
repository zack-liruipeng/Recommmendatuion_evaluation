...
public final class MovieLen_SVD_evaluation {

    /**
     * The number of folds.
     */
    public static final int N_FOLDS = 3;
     ...
     */
    public static final int FACTORS = 50;
    ...
    public static void recommend(final int nFolds, final String inPath, final String outPath) {
        for (int i = 0; i < nFolds; i++) {
            ...
            String factirizerClass = "org.apache.mahout.cf.taste.impl.recommender.svd.SVDPlusPlusFactorizer";
            int factors=FACTORS;
