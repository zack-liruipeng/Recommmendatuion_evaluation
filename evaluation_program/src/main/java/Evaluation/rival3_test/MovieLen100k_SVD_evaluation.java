...
public final class MovieLen100k_SVD_evaluation {
    ...
    private MovieLen100k_SVD_evaluation(){}
    ...
    public static void recommend(final int nFolds, final String inPath, final String outPath) {
        for (int i = 0; i < nFolds; i++) {
            ...
            String factirizerClass = "org.apache.mahout.cf.taste.impl.recommender.svd.FunkSVDFactorizer";
            int factors=FACTORS;
