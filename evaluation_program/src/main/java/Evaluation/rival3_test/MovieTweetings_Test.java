...
/*This is the test file for Cross Validated evaluator
 * For MovieTweeting10K
 */
...
import net.recommenders.rival.split.splitter.CrossValidationSplitter;
	...
	public final class MovieTweetings_Test  {
	    /**
	    ...
	    public static void main(final String[] args) {
	        String url = "https://github.com/zack-liruipeng/Recommmendatuion_evaluation/blob/master/MovieTweetings.zip";
	        ...
	        String dataFile = "data/MovieTweetings/MovieTweetings/u.data";
	        int nFolds = N_FOLDS;
	    ...
	    public static void evaluate(final int nFolds, final String splitPath, final String recPath) {
	        ...
	        System.out.println("Novelty:" + noveltyRes);
